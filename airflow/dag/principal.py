...
def ingest_csv_to_minio(path_file) -> DataFrame:
...
def ingest_landing_bronze(df_bronze: DataFrame,file_name:str) -> None:
...
def ingest_silver(df_bronze:DataFrame,file_name:str)-> DataFrame:
...
def ingest_gold(df_silver:DataFrame) -> None:
...
ingest_landing_bronze(df_bronze,file_name)
df_silver = ingest_silver(df_bronze,file_name)
ingest_gold(df_silver)
